...
Habbo Moedas são grátis! A cada 3 horas, vamos dar mais Moedas até um montante de
3000, para ter certeza de nunca iram acabar. Você não precisa fazer login para o hotel!
...
<div class="method idx1 nosmallprint"> 
    <div class="method-content"> 
        <h2>Quando é a próxima atualização de Moedas?</h2>
		...
		.countdown-seperator-bit { float: left; padding: 5px; vertical-align: middle; font-weight: bold; font-size: 120%; text-align: center; }
			...
			<ul>
				...
				<li class="countdown-seperator-bit" style="font-size: 70%; margin-left: 15px; font-weight: normal;">
					Quando o tempo atinge 0,<br />as suas Moedas serão dados.
				</li>
...
<script type="text/javascript">
			...
			{
				document.getElementById('credits-countdown').innerHTML = "<h3 style='color: darkgreen;'>Atualização de Moedas!</h3><p>Temos apenas uma atualização de créditos. Verifique se o seu inventário no Hotel!</p>";
...
<div class="disclaimer" style="border: 0 !important;"> 
    <h3><span>Habbo Moedas são gratis</span></h3>
    Nós nunca iremos cobrar para você ter moedas! Nossos créditos são e sempre serão gratis.<br />
	Se você tiver dúvidas entre em contato conosco, <a href="mailto:%StaffEmail%">Clique aqui</a>.
</div> 
