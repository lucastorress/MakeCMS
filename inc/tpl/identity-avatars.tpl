		...
		<div id="content">
            ...
            <div id="first-avatar">
                ...
                <div id="first-avatar-info">
                    ...
                    <div class="first-avatar-lastonline">�ltima Visita: <span><?php echo substr($datum = $row[2], 0, strpos($datum, ' ')); ?></span></div>

										<?php if ($row[4] <> $_SESSION['UBER_USER_H'])
											echo "<div id='first-avatar-play-link' style='color: darkred;'>Voc� n�o pode jogar com este Habbo.</a></div>";
										else
										{ ?>
