    ...
    <div class="redeem-balance"> 
        ...
        <p class="redeem-balance-text">Suas moedas:</p>
        <p><span class="redeem-balance-amount">%creditsBalance%</span></p> 
    </div> 
 
    <div class="redeem-redeeming-text"><p class="redeeming-text">Entre com o código de moedas para obte-la</p></div>
...
<div class="redeem-redeeming"> 
    ...
    <div class="redeem-redeeming-button"><a href="#" class="new-button green-button redeem-submit"><b><span></span>Obter</b><i></i></a></div>
