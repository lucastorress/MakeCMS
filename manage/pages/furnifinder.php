...
echo '<p>Essa ferramenta permite escanear o Habbo Original e encontrar novas atualiza��es para o seu habbo.</p><br />';
...
{
	echo '<Br /><br /><center style="font-size: 120%;"><i><b>Boas not�cias !</b><br />Encontramos novos m�veis para voc�.</i></center>';
}
