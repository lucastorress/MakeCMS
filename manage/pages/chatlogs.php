...
<p>
		Esta ferramenta monitora as conversas dos usu�rios. OBS: Ela n�o monitora o minimail e o Chat especial.
</p>

<br />

<p>
	<b>IMPORTANTE:</b> Voc� pode ver s� uma quantia de conversas.<br />
	A cada 2 semanas essas conversas s�o deletadas do nosso sistema.
</p>
...
{
	echo '<h2>Procurar resultados - Voc� procurou por "<span style="font-size: 125%;">' . clean($_POST['searchQuery']) . '</span>"</h2>';
...
else
{
	...
	<option value="1">Por usu�rio</option>
	<option value="2">Por mensagem</option>
	<option value="3">Por quarto (SOMENTE ID)</option>
	<option value="4">Segundos atr�s (MAX 600 seg.)</option>
	</select>
	
	<br /><br />
	
	Buscar (O usu�rio, a mensagem, o ID e a quantidade de segundos):&nbsp;
