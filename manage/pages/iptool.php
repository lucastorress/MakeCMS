...
<br /><p>Esta ferramenta pode mostrar os usu�rios que t�m mais de uma conta em nosso hotel e tamb�m pode mostrar o ip do usu�rio caso queira bani-lo permanente. <b>Pedimos para que veja o usu�rio primeiro em seguida o seu IP</b>.</p>';
...
{
	echo '<h2 style="font-size: 140%;">Usu�rios com o mesmo IP: ' . $ip . '</h2>';
