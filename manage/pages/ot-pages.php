...
if (isset($_GET['del']))
{
	fMessage('error', 'Voc� tem <b>certeza</b> que deseja deletar esta p�gina ? Isto n�o pode ser revertido.<br /><a href="index.php?_cmd=ot-pages&realdel=' . $_GET['del'] . '">SIM, DELETAR</a> - ou - <a href="index.php?_cmd=ot-pages">CANCELAR</a>');
}

if (isset($_GET['realdel']))
{
	fMessage('ok', 'P�gina deletada');
...
if (isset($_POST['update-order']))
{
	...
	fMessage('ok', 'Atualizar por ordem de p�gina.');
}

require_once "top.php";

echo '<h1>Administrar p�ginas do cat�logo</h1>';
...
if ($data != null)
{
	...
	echo '<input type="checkbox" name="gonew" value="y" checked>Criar e gerar outra p�gina para colocar itens<br />';
...
echo '<a href="index.php?_cmd=ot-pages&new"><b>Nova p�gina gerada</b></a><br /><br />';
...
echo '</table><br /><input type="submit" name="update-order" value="Salvar ordem da p�gina"> ou <input type="button" value="Cancelar" onclick="location.reload(true);"></form><br /><br />';
